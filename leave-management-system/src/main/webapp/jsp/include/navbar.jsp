		...
		<ul class="navbar-nav">
			<sec:authorize access="hasAuthority('Admin' )">
				<li class="nav-item"><a href="${teachers }"
					class="nav-link ${param.view eq 'teachers'? 'active':'' }"> <i
						class="bi bi-people"></i> Teachers
				</a></li>
			</sec:authorize>

			<sec:authorize access="hasAnyAuthority('Admin','Teacher')">
				<li class="nav-item"><a href="${classes }"
					class="nav-link ${param.view eq 'classes'? 'active':'' }"> <i
						class="bi bi-mortarboard"></i> Classes
				</a></li>
			...
			<li class="nav-item"><a href="${students }"
				...
				<li class="nav-item"><a href="${leaves }"
					class="nav-link ${param.view eq 'leaves'? 'active':'' }"> <i
						class="bi bi-inbox"></i> Leaves
				</a></li>
				</sec:authorize>

			<li class="nav-item"><a id="logoutMenu" class="nav-link "> <i
