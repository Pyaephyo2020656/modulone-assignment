...
public class LeaveForm {
	...
	public Map<String, Object> insertParamsforLeaves() {
		return Map.of(
	...
	public List<Map<String, Object>> insertParamsforLeavesDay() {
		return IntStream.iterate(0, a -> a + 1).limit(days)
			.mapToObj(a -> startDate.plusDays(a))
			.map(this::insertParamsforLeavesDay)
			.toList();
	}
	
	private Map<String, Object> insertParamsforLeavesDay(LocalDate leaveDate) {
		return Map.of(
